  ...
  return (
    <div className="prose-health">
      ...
      <WarningBlock
        ...
        Vitamin B12 లోపం తరచుగా subclinical మరియు నెమ్మదిగా పెరిగేది — రక్తహీనత కనిపించే ముందే నాడీ నష్టం జరగవచ్చు. ఏ మొక్కల ఆహారం కూడా B12 యొక్క నమ్మకమైన వనరు కాదు (fermented foods మరియు spirulina లో inactive analogues ఉంటాయి). భారతీయ శాఖాహారులు తప్పనిసరిగా పరిగణించాలి: (1) క్రమం తప్పకుండా B12 supplementation (కనీసం 2.2 mcg/రోజు, లేదా 1000 mcg వారానికి — supplements నుండి absorption తక్కువగా ఉంటుంది). (2) B12-fortified ఆహారాలు అందుబాటులో ఉంటే తీసుకోవడం. (3) పాలు, curd మరియు paneer క్రమంగా తీసుకోవడం (lacto-vegetarians). (4) B12 స్థాయిలు కాలానుగుణంగా పరీక్షించుకోవడం, ముఖ్యంగా శాఖాహారులు, గర్భిణీ స్త్రీలు మరియు వృద్ధులకు.
      </WarningBlock>
